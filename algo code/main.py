...
# hand_recordings = 'final_project_data_experiments/game1/game1.json'
hand_recordings = 'final_project_data_experiments/game2/game2.json'
#
# hand_recordings = 'final_project_data_experiments/half1/half1.json'
# hand_recordings = 'final_project_data_experiments/half2/half2.json'
#
# hand_recordings = 'final_project_data_experiments/synced1/synced1.json'
# hand_recordings = 'final_project_data_experiments/synced2/synced2.json'

# hand_recordings = 'final_project_data_experiments/unsynced1/unsynced1.json'
# hand_recordings = 'final_project_data_experiments/unsynced2/unsynced2.json'
...
# ########################################### Wavelet ############################################## as this dose not worck we are not going to display this right now
# time.sleep(1)
...
#     plt.savefig(f"wavelet_coherence_position_axis_{axis}.png")
#     plt.close()
#
...
#     plt.savefig(f"wavelet_coherence_velocity_axis_{axis}.png")
#     plt.close()
# ########################################### Wavelet ##############################################